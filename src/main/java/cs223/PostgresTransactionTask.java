...
public class PostgresTransactionTask implements Runnable {
    ...
    public PostgresTransactionTask(ArrayList<String> statements, Metric metric, boolean readonly, long taskStartTimeMillis) {
